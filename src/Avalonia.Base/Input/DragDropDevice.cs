...
namespace Avalonia.Input
{
    ...
    public class DragDropDevice : IDragDropDevice
    {
        ...
        private DragDropEffects DragEnter(IInputRoot inputRoot, Point point, IDataTransfer3 data, DragDropEffects effects, KeyModifiers modifiers)
        {
        ...
        private DragDropEffects DragOver(IInputRoot inputRoot, Point point, IDataTransfer3 data, DragDropEffects effects, KeyModifiers modifiers)
        {
        ...
        private void DragLeave(IInputRoot inputRoot, Point point, IDataTransfer3 data, DragDropEffects effects, KeyModifiers modifiers)
        {
            if (_lastTarget == null)
                return;
            try
        ...
        private DragDropEffects Drop(IInputRoot inputRoot, Point point, IDataTransfer3 data, DragDropEffects effects, KeyModifiers modifiers)
        {
            try
            {
