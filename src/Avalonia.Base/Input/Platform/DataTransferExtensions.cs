...
public static class DataTransferExtensions
{
    ...
    public static IEnumerable<DataFormat> GetFormats(this IDataTransfer dataTransfer)
    ...
    /// </remarks>
    public static async Task<T?> TryGetAsync<T>(this IDataTransfer dataTransfer, DataFormat format)
    {
